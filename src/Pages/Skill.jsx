    ...
    <Fragment>
      <div className={styles.skills}>
        ...
        <div className={styles.header}>
          ...
          <div className=" d-flex flex-wrap justify-content-center tools-container gap-5">
            <div className={`${styles.tools_card}    d-flex flex-column `}>
              <img src="/assets/images/html.png" alt=""  className={styles.tools}/>
              <p className="ex-para">HTML</p>
            </div>
            <div className={`${styles.tools_card}    d-flex flex-column `}>
              <img src="/assets/images/css.png" alt=""  className={styles.tools}/>
              <p className="ex-para">CSS</p>
            </div>
            <div className={`${styles.tools_card}    d-flex flex-column `}>
              <img src="/assets/images/sass.png" alt=""  className={styles.tools}/>
              <p className="ex-para">SASS</p>
            </div>
            <div className={`${styles.tools_card}    d-flex flex-column `}>
              <img src="/assets/images/js.png" alt=""  className={styles.tools}/>
              <p className="ex-para">JavaScript</p>
            </div>
            <div className={`${styles.tools_card}    d-flex flex-column `}>
              <img src="/assets/images/typescript.png" alt=""  className={styles.tools}/>
              <p className="ex-para">TypeScript</p>
            </div>
            <div className={`${styles.tools_card}    d-flex flex-column `}>
              <img src="/assets/images/React.png" alt=""  className={styles.tools}/>
              <p className="ex-para">React JS  & <br/>React Native</p>
            </div>
            <div className={`${styles.tools_card}    d-flex flex-column `}>
              <img src="/assets/images/redux.png" alt=""  className={styles.tools}/>
              <p className="ex-para">Redux</p>
            </div>
            <div className={`${styles.tools_card}    d-flex flex-column `}>
              <img src="/assets/images/nexts.webp" alt=""  className={styles.tools}/>
              <p className="ex-para">Next JS</p>
            </div>
            <div className={`${styles.tools_card}    d-flex flex-column `}>
              <img src="/assets/images/bootstrap.png" alt=""  className={styles.tools}/>
              <p className="ex-para">Bootstrap</p>
            </div>
            <div className={`${styles.tools_card}    d-flex flex-column `}>
              <img src="/assets/images/mui.png" alt=""  className={styles.tools}/>
              <p className="ex-para">Material UI</p>
            </div>
            <div className={`${styles.tools_card}    d-flex flex-column `}>
              <img src="/assets/images/styled.png" alt=""  className={styles.tools}/>
              <p className="ex-para">Styled <br/>Component</p>
            </div>
          </div>
        </div>
        ...
        <div className={styles.header}>
          ...
          <div className=" d-flex flex-wrap  justify-content-center tools-container gap-5">
            <div className={`${styles.tools_card}    d-flex flex-column `}>
              <img src="/assets/images/nodejs.png" alt=""  className={styles.tools}/>
            ...
            <div className={`${styles.tools_card}    d-flex flex-column `}>
              <img src="/assets/images/expressjs.png" alt=""  className={styles.tools}/>
              <p className="ex-para">Express JS</p>
            </div>
            <div className={`${styles.tools_card}    d-flex flex-column `}>
              <img src="/assets/images/mongo.png" alt=""  className={styles.tools}/>
        ...
        <div className={styles.header}>
          ...
          <div className=" d-flex flex-wrap  justify-content-center tools-container gap-5">
            ...
            <div className={`${styles.tools_card}    d-flex flex-column `}>
              <img src="/assets/images/github-mark-white.png" alt=""  className={styles.tools}/>
              <p className="ex-para">Github</p>
            </div>
            <div className={`${styles.tools_card}    d-flex flex-column `}>
              <img src="/assets/images/npm.png" alt=""  className={styles.tools}/>
              <p className="ex-para">NPM</p>
            </div>
            <div className={`${styles.tools_card}    d-flex flex-column `}>
              <img src="/assets/images/vs.png" alt=""  className={styles.tools}/>
